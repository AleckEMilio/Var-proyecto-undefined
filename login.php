<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $email      = mysqli_real_escape_string( $db,  // Guardar en db
                      filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) );  //ASIGNAR POST A ESAS VARIABLES
        // Para validar el email en el email


        $passsword  = mysqli_real_escape_string( $db,  // Guardar en db
                      $_POST['password']);     
        //SANITIZAR
